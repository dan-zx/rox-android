...
public class CustomFloatingActionsMenu extends ViewGroup {
    ...
    public CustomFloatingActionsMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CustomFloatingActionsMenu(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mCollapsedIcon = attr.getResourceId(com.grayfox.android.app.R.styleable.FloatingActionsMenu_fab_collapsedIcon, 0);
        attr.recycle();
